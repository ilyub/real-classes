...
class Accumulator2D {
    ...
    *[Symbol.iterator]() {
    ...
    get(key1, key2) {
        var _a, _b;
        const map = (_a = this.map.get(key1)) !== null && _a !== void 0 ? _a : new real_fns_1.ReadonlyMap();
        return real_fns_1.is.not.empty(key2) ? (_b = map.get(key2)) !== null && _b !== void 0 ? _b : [] : map;
    }
    /**
     * Pushes value.
     *
...
exports.Accumulator2D = Accumulator2D;
